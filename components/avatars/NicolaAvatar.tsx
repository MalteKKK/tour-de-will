...
export default function NicolaAvatar({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 230 250" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      {/* NICOLA BODY */}
      <g>
        <line x1="95" y1="180" x2="103" y2="195" stroke="#4a6fa5" strokeWidth="7" strokeLinecap="round" />
        <line x1="110" y1="180" x2="118" y2="196" stroke="#4a6fa5" strokeWidth="7" strokeLinecap="round" />
        <ellipse cx="103" cy="197" rx="6" ry="3" fill="#555" />
        <ellipse cx="118" cy="198" rx="6" ry="3" fill="#555" />

        <rect x="85" y="135" width="34" height="48" rx="10" fill="#3b82f6" />
        <path d="M88,138 C95,145 108,145 115,138" fill="none" stroke="#4a4a4a" strokeWidth="5" strokeLinecap="round" />
        <line x1="90" y1="142" x2="85" y2="162" stroke="#4a4a4a" strokeWidth="4" strokeLinecap="round" />
        <line x1="87" y1="160" x2="82" y2="165" stroke="#4a4a4a" strokeWidth="3" strokeLinecap="round" />

        <line x1="86" y1="150" x2="140" y2="145" stroke="#3b82f6" strokeWidth="6" strokeLinecap="round" />
        <line x1="118" y1="150" x2="145" y2="145" stroke="#3b82f6" strokeWidth="6" strokeLinecap="round" />
        ...
        <g transform="translate(102, 108)">
          ...
          <ellipse cx="-17" cy="2" rx="7" ry="16" fill="#c9a34d" />
          <ellipse cx="17" cy="2" rx="7" ry="16" fill="#c9a34d" />
          <path d="M-21,-8 Q-20,-22 -5,-20 Q5,-22 15,-20 Q21,-20 21,-8" fill="#c9a34d" />
          <ellipse cx="0" cy="-16" rx="18" ry="8" fill="#c9a34d" />
          <path d="M-10,-4 Q-7,-7 -3,-5" fill="none" stroke="#8a6e3e" strokeWidth="1.4" strokeLinecap="round" />
          <path d="M3,-5 Q7,-7 10,-4" fill="none" stroke="#8a6e3e" strokeWidth="1.4" strokeLinecap="round" />
          <ellipse cx="-7" cy="0" rx="3.5" ry="3" fill="white" />
          <ellipse cx="7" cy="0" rx="3.5" ry="3" fill="white" />
          <circle cx="-6.2" cy="0" r="2.2" fill="#5a7e4e" />
          <circle cx="7.8" cy="0" r="2.2" fill="#5a7e4e" />
          <circle cx="-5.7" cy="-0.5" r="0.8" fill="white" />
          <circle cx="8.3" cy="-0.5" r="0.8" fill="white" />
          <path d="M-1,4 Q0,7 1,4" fill="none" stroke="#d4a070" strokeWidth="1.2" strokeLinecap="round" />
